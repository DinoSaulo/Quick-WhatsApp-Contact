...
const cachedExecutablePath = resolveWithinDir(CHROME_DIR, version, "chrome-linux64", "chrome");
...
const destDir = resolveWithinDir(CHROME_DIR, version);
mkdirSync(destDir, { recursive: true });

const zipPath = resolveWithinDir(destDir, "chrome-linux64.zip");
